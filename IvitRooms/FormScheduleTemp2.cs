...
namespace IvitRooms
{
    public partial class FormScheduleTemp2 : Form
    {
        ...
        protected List<Schedule> tempsSchedule = new List<Schedule>();
        protected UserJConfig userJconfig = UserJConfig.Inst();
        public FormScheduleTemp2()
        {
            InitializeComponent();
        }

        private void FormScheduleTemp2_Load(object sender, EventArgs e)
        {
            ...
            chart2.Titles.Add(new System.Windows.Forms.DataVisualization.Charting.Title("Температура"));
            this.SetTreeVuew1();
            if (checkBox1.Checked == true)
            {
                this.SetTempsSchedulePeriod();
            }
            else
            {
                this.SetTempsSchedule();
            }
            this.SetListViev1();
            this.SetChart2();
        ...
        private void SetTempsSchedule()
        {
            ...
            foreach (var item in dir.GetFiles())
            {
                ...
                {
                    foreach (int id in userJconfig.formScheduleTemps.checkedIvits)
                    {
                ...
                tempsSchedule.Add(shed);
              
            }
            progressBar1.Visible = false;
        }

        private void SetTempsSchedulePeriod()
        {
        ...
        private void SetChart2()
        {
            ...
            chart2.ChartAreas[0].AxisY.Title = '\u2103'.ToString();
            ...
            foreach (Schedule ivit in tempsSchedule)
            {
                Int32 PK = 0;
        ...
        {
            userJconfig.formScheduleTemps.checkedIvits.Clear();
            foreach (ListViewItem item in listView1.CheckedItems)
            {
                userJconfig.formScheduleTemps.checkedIvits.Add(Convert.ToInt32(item.Name));
            }
            userJconfig.Save();
